...
EXPECTED_ABLATION_ARMS = {
    'fixed_clock': 'pose_only',
    'total_gradient': 'full',
    'frozen_pose': 'time_only',
}
if ABLATION_MODE and ARM != EXPECTED_ABLATION_ARMS[ABLATION_MODE]:
    raise ValueError(
        f'Ablation {ABLATION_MODE!r} requires arm '
        f'{EXPECTED_ABLATION_ARMS[ABLATION_MODE]!r}, got {ARM!r}')
...
TEACHER_PATH = os.environ.get(
    'ED3DGS_STAGE2_TEACHER_MODEL_PATH', '')
if not TEACHER_PATH:
...
OptimizationParams = dict(
    ...
    deformation_lr_max_steps=20_000,
...
print('FORMAL_COVERS_CONFIG ' + json.dumps({
    'arm': ARM,
